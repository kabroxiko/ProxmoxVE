...
function getInstallCommand(scriptPath = "", isAlpine = false, useGitea = false) {
  const githubUrl = `https://raw.githubusercontent.com/kabroxiko/${basePath}/main/${scriptPath}`;
  const giteaUrl = `https://git.kabroxiko.org/kabroxiko/${basePath}/raw/branch/main/${scriptPath}`;
